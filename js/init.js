		...
		// skelJS (probably don't need to change anything here unless you know what you're doing)
			skelJS: {
				...
				breakpoints: {
					...
					'wide':	{ range: '961-1880', containers: 'fluid', grid: { gutters: 40 } },
					'normal':	{ range: '961-1620', containers: 'fluid', grid: { gutters: 40 } },
					'narrow':	{ range: '640-960', containers: 'fluid', grid: { gutters: 30 } },
					'narrower':	{ range: '-640', containers: 'fluid', grid: { gutters: 30 } },
